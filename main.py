from display import display__ as _display_
from stages import stage
from words import the_word
import txtcolor as colr ## keep this as standard import, to consider the different color definitions
...
def main():
    ...
    ########## word actions
    chosen_word = the_word() # find the word

    chosen_word = chosen_word.lower() # a precaution in case any of the manually added words contains captial letters.

    display = _display_(chosen_word) ## create display and correct number of _ spaces
    ...
    while not end_of_game:
        ...
        if "_" not in display:
            colr.txtGreen(stage(lives)) ### print hangman symbol
            ...
            colr.txtRed(stage(lives)) ### print hangman symbol
            ...
            print(stage(lives)) ### print hangman symbol
